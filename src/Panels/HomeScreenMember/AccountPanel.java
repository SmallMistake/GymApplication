...
public class AccountPanel extends JPanel {
	...
	public AccountPanel(String username) {
		...
		rs = databaseConnector.sendStatement("SELECT memberFirst, memberLast, Username, memberEmail, memberBday, phoneNumber, areaCode FROM `member` WHERE Username = \"" + username + "\"");
		try {
			rs.next();
			...
			JLabel lblPhonenumber = new JLabel("(" + Integer.toString(rs.getInt("areaCode")) + ") " + Integer.toString(rs.getInt("phoneNumber")));
